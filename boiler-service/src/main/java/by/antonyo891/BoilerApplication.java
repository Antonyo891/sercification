...
//        BoilerConditionService cond = context.getBean(BoilerConditionService.class);
//        BoilerNTDService boilerNTDService = context.getBean(BoilerNTDService.class);
//        BoilerCondition conditionNow = cond.getConditionNow(boilerRepository.findAll().getFirst());
//        System.out.println(conditionNow);
//        System.out.println(boilerNTDService.getBoilerNTDByCondition(conditionNow));
